    ...
    <div className="flex flex-col md:flex-row items-center justify-between gap-10">
      ...
      <div className="basis-full md:basis-7/12 md:pr-8 md:border-r border-violet-500/30">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8 text-center sm:text-left">
          <div>
            <h3 className="text-3xl font-bold">10<span className="text-violet-500">+</span></h3>
            <p className="text-sm opacity-70">Projects</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold">2<span className="text-violet-500">+</span></h3>
            <p className="text-sm opacity-70">Years Exp</p>
          </div>
          <br></br>
          <div>
            <h3 className="text-3xl font-bold">2.9<span className="text-violet-500">/4.9</span></h3>
