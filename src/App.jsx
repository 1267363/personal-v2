  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="./assets/logo.png" className="w-10 rounded-md" alt="faris" />
              <p> Avoid Or Just Undertake IT</p>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Muhammad Agung Permana" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="Passionate Web Developer Dedicated To Creating Modern, High-Performance Digital Experiences Through Innovative And User-Friendly Solutions."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
       ...
       {/* About Section */}
<section className="mt-32" id="about" data-aos="fade-up">
  <div className="rounded-3xl border-[5px] border-violet-500/40 shadow-2xl bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#1a1a1a] p-8">
    <div className="flex flex-col md:flex-row items-center justify-between gap-10">
      
      {/* Kolom Teks */}
      <div className="basis-full md:basis-7/12 md:pr-8 md:border-r border-violet-500/30">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-5">About Me</h2>
        <BlurText
          text="I'm Muhammad Agung Permana, a web developer passionate about building modern, high-performance applications with intuitive user experiences..."
          delay={150}
          animateBy="words"
          direction="top"
        ...
        <div className="grid grid-cols-3 gap-4 mb-8 text-center sm:text-left">
          <div>
            <h3 className="text-3xl font-bold">5<span className="text-violet-500">+</span></h3>
            <p className="text-sm opacity-70">Projects</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold">1<span className="text-violet-500">+</span></h3>
            <p className="text-sm opacity-70">Years Exp</p>
          </div>
          <br></br>
          <div>
            <h3 className="text-3xl font-bold">2.99<span className="text-violet-500">/4.99</span></h3>
            <p className="text-sm opacity-70">GPA</p>
          </div>
        </div>
        <ShinyText text="Working with heart, creating with mind." className="text-violet-400" />
      </div>
      
      {/* Kolom ProfileCard (Menggantikan Lanyard) */}
      <div className="basis-full md:basis-5/12 flex justify-center items-center py-6">
        <ProfileCard
          name="M.Agung Permana"
          title="Web Developer"
          handle="Sky_ag"
          ...
          enableTilt={true}
          enableMobileTilt={false}
          // Anda bisa menyesuaikan props lainnya agar berbeda dengan Hero Section
        />
      </div>
          ...
          <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
            {listTools.map((tool) => (
              <div key={tool.id} data-aos="fade-up" data-aos-duration="1000" data-aos-delay={tool.dad} data-aos-once="true" className="flex items-center gap-4 p-4 border border-zinc-700 rounded-xl bg-zinc-900/60 backdrop-blur-md hover:bg-zinc-800/80 transition-all duration-300 group shadow-lg">
                <img src={tool.gambar} alt={tool.nama} className="w-16 h-16 object-contain bg-zinc-800 p-2 rounded-lg group-hover:bg-zinc-900 transition-all duration-300" />
        ...
        <div className="proyek mt-32 py-10" id="project" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
          ...
          <p className="text-base/loose text-center opacity-50 mb-10">Showcasing a selection of projects that reflect my skills, creativity, and passion.</p>
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="max-w-3xl mx-auto"> 
            <form
              action="https://formsubmit.co/muhammdagungpermana@gmail.com"
              method="POST"
