    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://www.instagram.com/_sky_ag/"><i className="ri-instagram-fill ri-2x"></i></a>
          <a href="https://wa.me/6285183408937"><i className="ri-whatsapp-fill ri-2x"></i></a>
          <a href="https://www.tiktok.com/@_sky_ag"><i className="ri-tiktok-fill ri-2x"></i></a>
        </div>
